  ...
  try {
    ...
    return (
      <>
        ...
        <div className="md:-mt-[75px] md:pt-[75px] md:h-dvh">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 w-full h-full border-b">
            {/* MEDIA CONTENT */}
            ...
            <section className="col-span-1">
              ...
              <div className="px-4 py-8">
                <ul>
                  ...
                  {team && (
                    <li>
                      <span className="font-bold">Equipo de trabajo:</span>{" "}
                      {team}
                    </li>
                  )}
                </ul>
